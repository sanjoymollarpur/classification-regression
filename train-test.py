...
# data_dir = "data/verified-data/aug/train"
data_dir = "data/verified-data/6-c/train"
...
print(len(images))
X_train, X_test, y_train, y_test = train_test_split(images, labels1, test_size=0.001, random_state=42)



data_dir = "data/verified-data/aug/test"
data_dir = "data/verified-data/6-c/test"
images, labels = load_images_and_labels(data_dir)
print(labels)
labels1=[]
